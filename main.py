...
async def on_ready():
    ...
    manage_commands.add_slash_command(bot_id=793546056934883328, bot_token=config("TOKEN"), guild_id=793495102566957096, cmd_name="menu", description="Open the Navigation Menu")
