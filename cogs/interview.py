...
:white_check_mark: **__REACT NOW__**""")
        ...
        if payload.emoji.name == '🇭':
            ...
            await waitUntilDone()
            await newInt.send("What is the Java Edition **IP** of the ATP City Main/ Parkour Server?\n\nA. bedrock.atpcity.ga\nB. java.atpcity.ga\nC. be.atpcity.ga\nD. parkour.atpcity.ga")
            await waitUntilDone()
            ...
            await waitUntilDone()
            await newInt.send("""Situation: a player with the username `JebPlayz` needs help, and approaches you. Assume that you are a helper in ATP City, and your username is `BobbyPlayz`.""")
